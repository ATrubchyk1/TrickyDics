...
public class UserMoveTimerLimiter : MonoBehaviour
{
    [SerializeField] private float _timeLimitedDuration;
    ...
    private void StartTimeLimiterSequence()
    {
        ...
        _timeLimiterSequence.Append(transform.DOScale(_finishTimeLimiterScale, _timeLimitedDuration));
